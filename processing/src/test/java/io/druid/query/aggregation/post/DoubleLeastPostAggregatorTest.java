...
public class DoubleLeastPostAggregatorTest
{
  ...
  {
    DoubleLeastPostAggregator greatestPostAggregator;
    ...
    greatestPostAggregator = new DoubleLeastPostAggregator("least", postAggregatorList);
    Assert.assertEquals(3.0, greatestPostAggregator.compute(metricValues));
  }
